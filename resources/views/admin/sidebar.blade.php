      ...
      <div class="tab-pane fade" id="chats-section" role="tabpanel" aria-labelledby="chats-section">
        ...
        <ul class="chat-list">
          <li class="list active">
            <div class="profile"><img src="../img/Ellipse 7.png" alt="image"><span class="online"></span></div>
            <div class="info">
              <p>Thomas Douglas</p>
              <p>Available</p>
            </div>
          ...
          <li class="list">
            <div class="profile"><img src="../img/Ellipse 7.png" alt="image"><span class="offline"></span></div>
            <div class="info">
          ...
          <li class="list">
            <div class="profile"><img src="../img/img_testi.png" alt="image"><span class="online"></span></div>
            <div class="info">
          ...
          <li class="list">
            <div class="profile"><img src="../img/img_testi_2.png" alt="image"><span class="online"></span></div>
            <div class="info">
              <p>Sarah Graves</p>
              <p>Available</p>
            </div>

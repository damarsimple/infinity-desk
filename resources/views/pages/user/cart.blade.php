...
@section('content')
<section class="pt-4 pb-4" id="cart">
  <div class="container mx-auto px-4">
    <div class="flex flex-wrap" style="margin-left: -1rem; margin-right: -1rem;">
      <div class="w-full px-4 mb-4 md:w-8/12 md:mb-0" id="shopping-cart">
        ...
        <div class="border-b border-gray-200 mb-4 hidden md:block">
          <div class="flex flex-start items-center pb-2 -mx-4">
            <div class="cart-header cart-column px-4 flex-none">
              <div class="" style="width: 90px">
                <h6>Photo</h6>
              </div>
            </div>
            <div class="cart-header cart-column px-4 w-5/12">
              <div class="">
                <h6>Product</h6>
              </div>
            </div>
            ...
            <div class="cart-header cart-column px-4 w-2/12">
        ...
        <!-- START: ROW 1 -->
        <div
          class="shop-item flex flex-start flex-wrap items-center mb-4 -mx-4"
          data-row="1"
        >
          <div class="px-4 flex-none">
            <div class="" style="width: 90px; height: 90px">
              <img
                src="{{ ('frontend/images/img_poduct_3.png') }}"
                alt="chair-1"
        ...
        >
          <div class="px-4 flex-none">
            <div class="" style="width: 90px; height: 90px">
              <img
                src="{{ url('frontend/images/img_product_3.png') }}"
                alt="chair-2"
                class="object-cover rounded-xl w-full h-full"
              />
            </div>
        ...
        >
          <div class="px-4 flex-none">
            <div class="" style="width: 90px; height: 90px">
              <img
                src="{{ ('frontend/images/img_product_3.png') }}"
                alt="chair-3"
                class="object-cover rounded-xl w-full h-full"
              />
            </div>
        ...
        <div class="bg-gray-100 px-4 py-6 md:p-8 md:rounded-3xl">
          <form action="success.html">
            <div class="flex flex-start mb-6">
              <h3 class="text-2xl">Shopping Summary</h3>
            </div>
            ...
            <div class="flex flex-col mb-4">
              ...
              /> --}}
              <select id="address" class="form-select form-select-lg mb-3 border-gray-200 rounded-lg px-4 py-2 bg-white text-sm focus:border-blue-200 focus:outline-none" aria-label="Disable address" disabled>
                <option selected>Villa Balaraja Blok C9 no.5</option>
